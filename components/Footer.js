...
const Footer = () => {
  return (
     ...
     //              </div>
    <div className='mt-90 bg-[#101828]'>
        <div className="container mx-auto py-10">
           <div className="grid grid-col-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-10 text-white">
            <div className="flex flex-col gap-4">
            <img src="https://putatoe.com/img/logo.png" alt="image" />
               <p>Putatoe Solutions Private Limited</p>
            </div>
           ...
           <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between items-center pt-20 pb-5">
                <p className='text-gray-500'>© PUTATTOE. All rights reserved.</p>
